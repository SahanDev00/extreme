...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    }/Customer/GetByEmail?EmailAddress=${encodeURIComponent(formData.email)}`;
  ...
  return (
    <div className="w-full min-h-screen pt-[50px]">
      ...
      <p className="text-sm pb-2 text-center font-semibold text-gray-500 mt-5 font-poppins">
      ...
      <Link to="/forgot-password">
        <p className="text-center text-sm font-poppins text-blue-500 font-semibold cursor-pointer hover:text-cyan-600">
          Forgot password?
        </p>
      </Link>
    </div>
