      ...
      <div className='w-full mt-[50px] xl:h-[650px] flex flex-col items-end mb-10'>
        <div className='w-[93%] flex flex-col justify-center'>
          <h1 className='text-2xl sm:text-2xl font-roboto font-semibold'>
            The Featured. <span className='text-gray-500'>Take a look at what’s featured, right now.</span>
          </h1>
        </div>
          ...
          <Slider {...settings}>
            {items.map((item) => (
                <div className='sm:pl-2 h-[550px] sm:h-[500px] md:h-[480px] lg:h-[500px] xl:h-[670px]'>
                    <div className='max-w-[410px] mx-auto max-h-[520px] mt-7 rounded-2xl shadow-md bg-white cursor-pointer hover:shadow-lg hover:scale-[102%] duration-300'>
                        <div className='p-8'>
                        ...
                        <img src={item.image} className='p-3 object-contain' alt="" />
                    </div>
                </div>
            ))}
          </Slider>
